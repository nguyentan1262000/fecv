...
import { fetchCreateGroup } from '../services/groupAPI';
...
const FormCreateGroup = () => {
    ...
    return <div className="form-add-entity">
        ...
        >
            <Form.Item label="Mame" name="name">
            <Input placeholder="name" />
        </Form.Item>
        {/* <Form.Item label="Manager Group" name="manager">
      ...
      <Form.Item label="Description" name="description">
        ...
        <NavLink to="/group" className=' btn-cancel mr-4 w-[150px]' type='default'>
        Cancel
        </NavLink>
