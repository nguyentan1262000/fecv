...
import { fetchAdminUpdateAccount, fetchCreateNewAccount, fetchGetDetailUserById, fetchGetMyProfile } from '../services/userAPI';
...
const Profile = () => {
    ...
    const [fileList,setFileList] = useState([
      {
        uid: '-1', // UID là duy nhất cho mỗi file
        name: 'existing_image.jpg', // Tên ảnh (tùy chỉnh theo nhu cầu)
        status: 'done', // Trạng thái của file (done để hiển thị ngay lập tức)
        url: 'https://vcdn1-dulich.vnecdn.net/2021/07/16/1-1626437591.jpg?w=460&h=0&q=100&dpr=2&fit=crop&s=i2M2IgCcw574LT-bXFY92g', // URL của ảnh
      }
    ]);
  ...
  const onFinish = (values) => {
    ...
    const getUser = async (idUser) => {
        const res = await fetchGetMyProfile();
    ...
    return <div className="form-add-entity">
      ...
      <Form.Item label="Role" name="role">
        ...
        <NavLink to="/account/list" className='btn-cancel mr-4 w-[150px]' type='default'>Cancel</NavLink>
